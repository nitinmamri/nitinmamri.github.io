...
<title>NITIN PHOTO STUDIO AND JAN SEVA KENDRA</title>
<style>
html, body {
    margin: 0;
    padding: 0;
    font-family: 'Segoe UI', Arial, sans-serif;
    background: linear-gradient(to right, #ffe5ec, #fdc1de);
    overflow-x: hidden;
}
/* HEADER */
.top-title {
    ...
    gap: 30px;
    background: linear-gradient(90deg, #001f4d, #003366, #001a33);
    height: 200px;
    padding: 0 30px;
...
.logo::before {
    ...
    animation: backgroundLightShift 6s ease-in-out infinite;
    filter: blur(16px) brightness(1.3) saturate(1.5);
    opacity: 0.65;
    z-index: -1;
}
.logo img {
...
<!-- WhatsApp Number Modal Background -->
<div id="modalBg"></div>
